...
from .plugins.conda import conda_environment, conda_flow_decorator, conda_step_decorator
...
metaflow.plugins.FLOW_DECORATORS = metaflow.plugins._merge_lists(
    metaflow.plugins.FLOW_DECORATORS, [conda_flow_decorator.CondaFlowDecorator], "name"
)
